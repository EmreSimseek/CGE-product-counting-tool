...
def main():
    # JSON dosya yolları
    json_file_1 = "E:/Proje repo genel/3001-works/logx/3001json/intermac2/dataFarkli.json"
    json_file_2 = "E:/Proje repo genel/3001-works/logx/3001json/intermac2/dataFarkli.json"
    ...
    try:
        ...
        # Filtrelenmiş veri yoksa uyar
        if not sorted_filtered_data:
            messagebox.showinfo("Bilgi", "Filtrelenmiş veri bulunamadı.")
            return

        # Yeni JSON dosyasına yaz
        output_file = "filtered_check_1_2.json"
        with open(output_file, 'w', encoding='utf-8') as f:
            json.dump(sorted_filtered_data, f, ensure_ascii=False, indent=4)

        messagebox.showinfo("Başarılı", f"Filtrelenmiş veriler {output_file} dosyasına kaydedildi.")
...
# def main():
#     # JSON dosya yollarınızı buraya ekleyin   Tüm gün boyunca kesilen camların eksiksiz verisi 
#     json_file_1 = "/home/emre/Masaüstü/series_check/2101json/intermac1/dataAyni.json"  # Örneğin: "data1.json"
#     json_file_2 = "/home/emre/Masaüstü/series_check/2101json/intermac1/dataAyni.json" # Örneğin: "data2.json"
...
#     # Filtrelenmiş verileri yeni bir JSON dosyasına yazma
#     # Çıkış dosyasının yolunu belirleyin. Örneğin, aynı dizinde 'filtered_check_1_2.json'
#     output_json_file = "/home/emre/Masaüstü/series_check/2101json/intermac1/filtered_check_1_2.json"

#     try:
#         with open(output_json_file, 'w', encoding='utf-8') as f:
#             json.dump(sorted_filtered_data, f, ensure_ascii=False, indent=4)
#         messagebox.showinfo("Başarılı", f"Filtrelenmiş veriler '{output_json_file}' dosyasına yazıldı.")
#     except Exception as e:
#         messagebox.showerror("Hata", f"Veriler yazılırken bir hata oluştu: {e}")
#         return
